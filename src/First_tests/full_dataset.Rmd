...
library(ggplot2)
```
R² statistics calculation function
...
```{r}
df.x = read.csv("../../../data/X_untouched.csv") # The data directly downloaded from the Dropbox
df.y = read.csv("../../../data/Y_untouched.csv") # The data directly downloaded from the Dropbox
